//12 months defined in columns and need to calculate avg of each row
//Then we must define sum between 2 for loops (to calc each row operations and reset to 0 one after one)

public class Arrayabg2 {
